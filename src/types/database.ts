  ...
  public: {
    Tables: {
      ...
      municipal_tax_debts: TableDef<{
        ...
        portal_inscricao: string | null;
        portal_cai: string | null;
        detalhes: Json;
        fetched_at: string;
        created_at: string;
        updated_at: string;
      ...
      municipal_tax_collection_runs: TableDef<{
        id: string;
        office_id: string;
        robot_technical_id: string;
      ...
      nfs_stats: TableDef<{
        ...
        service_codes: Json;
        service_codes_emitidas: Json;
        service_codes_recebidas: Json;
        created_at: string;
        updated_at: string;
      }>;
      ...
      simple_national_periods: TableDef<{
        id: string;
        office_id: string;
        company_id: string;
        ...
        municipal_iss_rate: number | null;
        subject_to_factor_r: boolean;
        base_annex: string;
        activity_label: string | null;
        created_at: string;
        updated_at: string;
      }>;
      simple_national_entries: TableDef<{
        id: string;
        office_id: string;
        period_id: string;
        company_id: string;
        reference_month: string;
        entry_type: "revenue" | "payroll";
        amount: number;
        created_at: string;
        updated_at: string;
      }>;
      simple_national_historical_revenue_allocations: TableDef<{
        id: string;
        office_id: string;
        period_id: string;
        company_id: string;
      ...
      simple_national_revenue_segments: TableDef<{
        id: string;
        office_id: string;
        period_id: string;
        company_id: string;
      ...
      simple_national_payroll_compositions: TableDef<{
        id: string;
        office_id: string;
        period_id: string;
        company_id: string;
        ...
        individual_contractors_amount: number;
        thirteenth_salary_amount: number;
        employer_cpp_amount: number;
        fgts_amount: number;
        excluded_profit_distribution_amount: number;
        excluded_rent_amount: number;
        excluded_interns_amount: number;
        excluded_mei_amount: number;
        created_at: string;
        updated_at: string;
      }>;
      simple_national_calculations: TableDef<{
        id: string;
        office_id: string;
        period_id: string;
        company_id: string;
    ...
    Functions: {
      ...
      get_authorized_file_paths: {
        Args: { requested_paths?: string[] | null };
